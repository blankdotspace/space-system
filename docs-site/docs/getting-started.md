...
- Check out [Fidget Overview](./systems/fidgets.md) to create fidgets
- Check [Configuration System](./systems/configuration.md) for how configs work
- Review [Project Structure](./project-structure.md) to understand the codebase
