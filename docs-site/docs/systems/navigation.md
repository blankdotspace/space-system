...
- [Configuration System](./configuration.md) - How navigation config is stored
- [Space Architecture](./spaces.md) - How navigation pages are stored as Spaces
- [State Management](../architecture/state-management.md) - Zustand store architecture
