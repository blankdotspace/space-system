...
const initMixpanel = () => {
  ...
  if (window.mixpanel.__isInitialized) return;
...
const analyticsReady = () =>
  typeof window !== "undefined" && window.mixpanel && window.mixpanel.__isInitialized;
