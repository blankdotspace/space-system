...
=== End Debug Info ===`;
  ...
  useEffect(() => {
    ...
    const scanIframes = () => {
      const iframes = document.querySelectorAll<HTMLIFrameElement>('iframe[data-blankspace-context]');
                      ...
                      try {
                        ...
                        try {
                          ...
                          const mockSdkHost = createMiniAppSdkHost(
                            testContext,
                            (window as any).__blankspaceMiniAppEthProvider,
                            testIframe,
                            testDomain,
                            {
                          ...
                          steps[steps.length - 1] = { 
                            ...
                            data: {
                              domain: testDomain,
                              userFid: testUserFid,
                              hasEthProvider: !!(window as any).__blankspaceMiniAppEthProvider,
                            },
                          };
                          setQuickAuthTest({ status: 'testing', steps: [...steps] });
